...
class chromium_url_conan_project(ConanFile):
    name = "chromium_url"
    ...
    description = "modified `url` library from chromium"
    topics = ('c++')
    ...
    def package_info(self):
        #self.cpp_info.libs = ["chromium_url"]
        ...
        #  os.path.join("base", "third_party", "url"))
        #self.cpp_info.includedirs.append(
        #  os.path.join("base", "third_party", "url", "compat"))
